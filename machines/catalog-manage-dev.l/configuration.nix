...

{
  ...
  noo.services.catalog = {
    ...
    frontendManage = {
      enable = true;
      serverUrl = "https://upravljanje-katalog.rwx.si/api";
      ...
      redirectUriWeb = "https://upravljanje-katalog.rwx.si/login";
    };
    coursePictures = {
      enable = true;
      address = "https://upravljanje-katalog.rwx.si/";
    };
    backend = {
      enable = true;
      secrets = config.age.secrets."catalog-secrets".path;
      frontend = "https://upravljanje-katalog.rwx.si";
